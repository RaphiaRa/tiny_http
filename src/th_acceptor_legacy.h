#ifndef TH_ACCEPTOR_LEGACY_H
#define TH_ACCEPTOR_LEGACY_H
...
typedef struct th_acceptor_legacy {
    th_context* context;
    th_allocator* allocator;
    th_io_handle* handle;
} th_acceptor_legacy;

typedef struct th_acceptor_legacy_opt {
    bool reuse_addr;
    bool reuse_port;
} th_acceptor_legacy_opt;

TH_PRIVATE(th_err)
th_acceptor_legacy_init(th_acceptor_legacy* acceptor, th_context* context,
                        th_allocator* allocator,
                        const char* addr, const char* port);

/** th_acceptor_legacy_async_accept
 ...
 */
TH_PRIVATE(void)
th_acceptor_legacy_async_accept(th_acceptor_legacy* acceptor, th_address* addr, th_io_handler* handler);

TH_PRIVATE(void)
th_acceptor_legacy_cancel(th_acceptor_legacy* acceptor);

TH_PRIVATE(void)
th_acceptor_legacy_deinit(th_acceptor_legacy* acceptor);
